...
echo "$ILIAS_CRON_PERIOD $_ILIAS_EXEC_AS_WWW_DATA $(which php) $ILIAS_WEB_DIR/cron/cron.php \"$ILIAS_CRON_USER_LOGIN\" \"$ILIAS_CRON_USER_PASSWORD\" \"$ILIAS_COMMON_CLIENT_ID\" >> \"$ILIAS_CRON_LOG_FILE\" 2>&1" > "$ILIAS_CRON_FILE"
